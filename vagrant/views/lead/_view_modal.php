    ...
    echo '<div class="slide-panel-content">
            <div class="slide-panel-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn-close-panel" onclick="closeSlidePanel()">
            ...
            <div class="slide-panel-body">
                <div class="text-center text-danger py-5">
                    ...
                    <button class="btn btn-secondary btn-sm mt-3" onclick="closeSlidePanel()">Cerrar</button>
                </div>
            </div>
            <div class="slide-panel-footer">
                <button class="btn-footer btn-footer-secondary" onclick="closeSlidePanel()">
...
<div class="slide-panel-content">
    ...
    <div class="slide-panel-body">
        ...
        <div class="profile-section">
            ...
            <div class="profile-actions">
                ...
                <?php endif; ?>
                <a href="#" class="action-btn action-btn-meeting" onclick="event.preventDefault(); closeSlidePanel(); window.location.href='<?= Url::to(['calendar/create', 'leadId' => $model->id_lead]) ?>';">
        ...
        <div class="list-section">
            <div class="list-header">
                ...
                <a href="<?= Url::to(['quote/create', 'leadId' => $model->id_lead]) ?>" target="_blank" class="list-add" onclick="closeSlidePanel();">
        ...
        <div class="list-section">
            <div class="list-header">
                ...
                <a href="<?= Url::to(['sales-tracking/create', 'leadId' => $model->id_lead]) ?>" target="_blank" class="list-add" onclick="closeSlidePanel();">
                    <i class="fas fa-plus"></i>
                </a>
            </div>
            <?php if (!empty($trackings)): ?>
                ...
                <div class="list-item-activity">
                    <span class="activity-icon" style="background: <?= $tracking->status_sales == 'Llamada' ? '#28a745' : ($tracking->status_sales == 'Cita' ? '#ffc107' : ($tracking->status_sales == 'Reunión' ? '#4e73df' : '#17a2b8')) ?>;">
                        <i class="fas <?= $tracking->status_sales == 'Llamada' ? 'fa-phone' : ($tracking->status_sales == 'Cita' ? 'fa-calendar-check' : ($tracking->status_sales == 'Reunión' ? 'fa-users' : 'fa-comment')) ?>"></i>
                    </span>
                    <span class="activity-text"><?= Html::encode($tracking->status_sales) ?></span>
    ...
    <!-- ========================================== -->
    <div class="slide-panel-footer">
        <a href="<?= Url::to(['lead/update', 'id' => $model->id_lead, 'return' => 'index']) ?>" target="_blank" class="btn-footer btn-footer-primary" onclick="closeSlidePanel();">
            <i class="fas fa-edit"></i> Editar
        </a>
        <a href="<?= Url::to(['sales-tracking/create', 'leadId' => $model->id_lead]) ?>" target="_blank" class="btn-footer btn-footer-success" onclick="closeSlidePanel();">
            <i class="fas fa-calendar-plus"></i> Seguimiento
        </a>
        <a href="<?= Url::to(['quote/create', 'leadId' => $model->id_lead]) ?>" target="_blank" class="btn-footer btn-footer-info" onclick="closeSlidePanel();">
            <i class="fas fa-file-invoice"></i> Cotización
        </a>
        <a href="<?= Url::to(['lead/view', 'id' => $model->id_lead]) ?>" target="_blank" class="btn-footer btn-footer-secondary" onclick="closeSlidePanel();">
